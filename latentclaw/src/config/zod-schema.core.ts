  ...
  .object({
    ...
    latentMas: z
      .object({
        ...
        latentSteps: z.number().int().min(0).max(80).optional(),
        prompt: z.union([z.literal("sequential"), z.literal("hierarchical")]).optional(),
        ...
        thinkToken: z.boolean().optional(),
        latentSpaceRealign: z.boolean().optional(),
        torchDtype: z
          .union([
            z.literal("auto"),
            z.literal("bfloat16"),
          ...
          .optional(),
        historyTurns: z.number().int().positive().max(32).optional(),
      })
      .strict()
      .optional(),
  })
